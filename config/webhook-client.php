...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => env('MIDTRANS_SERVER_KEY'),
            ...
            'signature_validator' => \App\Services\Midtrans\SignatureValidator::class,
             ...
             */
            'process_webhook_job' => \App\Services\Midtrans\ProcessWebhookJob::class,
        ],
    ],
