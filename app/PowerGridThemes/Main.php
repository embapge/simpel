...
use PowerComponents\LivewirePowerGrid\Themes\Components\{Actions, Checkbox, ClickToCopy, Cols, Editable, FilterBoolean, FilterDatePicker, FilterInputText, FilterMultiSelect, FilterNumber, FilterSelect, Footer, Table, Radio, Toggleable, SearchBox};

class Main extends Bootstrap5
{
    public string $name = 'bootstrap5';

    public function table(): Table
    {
        return Theme::table('table table-hover table-checkable table-highlight-head mb-2')
