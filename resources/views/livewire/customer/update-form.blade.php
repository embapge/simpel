<div>
    <div class="modal fade" id="CustomerUpdateModal" tabindex="-1" style="display: none;" aria-hidden="true" data-bs-focus="false" wire:ignore.self>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-xl-3 mb-3">
                        ...
                        <input type="text" id="email" wire:model='form.email' class="form-control @error('form.email') is-invalid @enderror" placeholder="example@test.com">
                        @error('form.email')
                            <span class="invalid-feedback">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-xl-3 mb-3">
                        ...
                        <input type="text" id="phone_number" wire:model='form.phone_number' class="form-control @error('form.phone_number') is-invalid @enderror" placeholder="08121937XXXX">
                    ...
                    <div class="col-xl-3 mb-3">
                        ...
                        <input type="text" id="website" wire:model='form.website' class="form-control" placeholder="example.com">
                    </div>
                    <div class="col-xl-5 mb-3">
                        <label for="address" class="form-label">Address</label>
                        <textarea name="" id="" cols="1" rows="3" wire:model='form.address' class="form-control" placeholder="JL. Sesame Raya"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" wire:model="form.emails.{{ $iEmail }}.name" class="form-control @error('form.emails.'.$iEmail.'.name') is-invalid @enderror" placeholder="John Doe">
                    ...
                    <div class="col-xl-6 mb-3">
                        ...
                        <div class="" wire:key="{{ $iPhone }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" wire:model="form.phones.{{ $iPhone }}.name" class="form-control @error('form.phones.'.$iPhone.'.name') is-invalid @enderror" placeholder="John Doe">
