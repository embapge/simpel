        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-xl-5 mb-3">
                    ...
                    <textarea name="" id="" cols="1" rows="3" wire:model='form.address' class="form-control @error('form.address') is-invalid @enderror" placeholder="JL. Sesame Raya"></textarea>
                    @error('form.address')
                        <span class="invalid-feedback">
                            {{ $message }}
                        </span>
                        ...
                        <div class="" wire:key="{{ $iPhone }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <input type="text" wire:model="form.phones.{{ $iEmail }}.name" class="form-control @error('form.phones.'.$iEmail.'.name') is-invalid @enderror" placeholder="John Doe">
